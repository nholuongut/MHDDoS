...
<p align="center">
<a href="#"><img alt="MH-DDoS forks" src="https://img.shields.io/github/forks/nholuongut/MHDDoS?style=for-the-badge"></a>
<a href="#"><img alt="MH-DDoS last commit (main)" src="https://img.shields.io/github/last-commit/nholuongut/MHDDoS/main?color=green&style=for-the-badge"></a>
<a href="#"><img alt="MH-DDoS Repo stars" src="https://img.shields.io/github/stars/nholuongut/MHDDoS?style=for-the-badge&color=yellow"></a>
<a href="#"><img alt="MH-DDoS License" src="https://img.shields.io/github/license/nholuongut/MHDDoS?color=orange&style=for-the-badge"></a>
<a href="https://github.com/nholuongut/MHDDoS/issues"><img alt="nholuongut issues" src="https://img.shields.io/github/issues/nholuongut/MHDDoS?color=purple&style=for-the-badge"></a>
...
You can download it from [GitHub Releases](https://github.com/nholuongut/MHDDoS/releases)
...
* [Python3][python3]
* [PyRoxy](https://github.com/nholuongut/PyRoxy)
...
You can read it from [GitHub Wiki](https://github.com/nholuongut/MHDDoS/wiki)

**Clone and Install Script**

```shell script
git clone https://github.com/nholuongut/MHDDoS.git
cd MHDDoS
...
```shell script
apt -y update && apt -y install curl wget libcurl4 libssl-dev python3 python3-pip make cmake automake autoconf m4 build-essential git && git clone https://github.com/nholuongut/MHDDoS.git && cd MH* && pip3 install -r requirements.txt
```

[python3]: https://python.org 'Python3'
[github issues]: https://github.com/nholuongut/MHDDoS/issues 'enter'
